        ...
        if not video_id:
            ...
            if not comments:
                ...
                if result:
                    ...
                    if video_meta:
                        thumb = (
                            f"<img src=\'{video_meta[\'thumbnail\']}\' "
                            "style=\'width:130px;border-radius:6px;flex-shrink:0;object-fit:cover;\'>"
                        ...
                        <div class="video-info-card">
                            ...
                            <div style="flex:1;min-width:0;">
                                ...
                                <p style="color:#666;font-size:0.82rem;margin:0 0 0.7rem 0;">
                                    {video_meta[\'channel\']} &nbsp;\u00b7&nbsp; {video_meta[\'published_at\']}
                                </p>
                                <div style="display:flex;gap:1.2rem;flex-wrap:wrap;">
                                    <span style="color:#666;font-size:0.78rem;">{format_number(video_meta[\'view_count\'])} views</span>
                                    <span style="color:#666;font-size:0.78rem;">{format_number(video_meta[\'like_count\'])} likes</span>
                                    <span style="color:#666;font-size:0.78rem;">{format_number(video_meta[\'comment_count\'])} comments</span>
                                </div>
                            </div>
                        </div>""", unsafe_allow_html=True)
                    ...
                    if verdict == "FIT":
                        v_class, v_emoji, v_text, v_color = "verdict-fit",     "\u2705", "FIT \u2014 Worth Watching",        "#22c55e"
                    elif verdict == "NO_FIT":
                        v_class, v_emoji, v_text, v_color = "verdict-nofit",   "\u274c", "NO FIT \u2014 Not Recommended",    "#ef4444"
                    else:
                        v_class, v_emoji, v_text, v_color = "verdict-caution", "\u26a0\ufe0f", "CAUTION \u2014 Proceed Carefully", "#eab308"
                    ...
                    tab1, tab2, tab3, tab4, tab5 = st.tabs([
                        "\U0001f4cb Analysis", "\U0001f4ac Top Comments",
                        "\U0001f4c8 Sentiment", "\U0001f4a1 Tips & Keywords", "\U0001f4e5 Export"
                    ])
                    ...
                    with tab1:
                        ...
                        st.markdown(
                            f\'<div class="glass-card"><p style="color:#aaa;font-size:0.92rem;line-height:1.75;margin:0;">{result.get("summary","No summary.")}</p></div>\',
                            unsafe_allow_html=True,
                        )
                            ...
                            for i, c in enumerate(comments[:10]):
                                ...
                                <div class="comment-card" style="animation-delay:{i*0.05}s;">
                                    <div style="display:flex;justify-content:space-between;align-items:center;">
                                        ...
                                        <span class="comment-likes">{likes_str} likes \u00b7 {c[\'published_at\']}</span>
                                    </div>
                                    <p class="comment-text">{c[\'text\'][:320]}{"..." if len(c[\'text\'])>320 else ""}</p>
                                </div>""", unsafe_allow_html=True)
                        else:
                    ...
                    with tab5:
                        ...
                        st.download_button(
                            ...
                            data=report_md,
                            file_name=f"tubefit_{video_id}_{datetime.now().strftime(\'%Y%m%d_%H%M\')}.md",
                            mime="text/markdown",
                        ...
                        <div class="glass-card" style="margin-top:1rem;">
                            <p style="color:#555;font-size:0.82rem;margin:0;line-height:1.9;">
                                ...
                                Analysed &nbsp;\u00b7&nbsp; <span style="color:#888;">{datetime.now().strftime("%b %d, %Y at %H:%M")}</span><br>
